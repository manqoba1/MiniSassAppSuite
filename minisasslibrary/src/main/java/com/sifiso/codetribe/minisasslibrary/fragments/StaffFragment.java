...
public class StaffFragment extends Fragment {
    ...
    private void sendData() {
        ...
        if (!isUpdate) {
            ...
            companyStaff = new TeamMemberDTO();
            companyStaff.setTeamMemberID(SharedUtil.getTeamMember(ctx).getTeamMemberID());
        } else {
        ...
        WebSocketUtil.sendRequest(ctx, Statics.MINI_SASS_ENDPOINT, w, new WebSocketUtil.WebSocketListener() {
            ...
            public void onMessage(final ResponseDTO response) {
                ...
                companyStaff = response.getTeamMember();
    ...
    public void setCompanyStaff(TeamMemberDTO companyStaff) {
