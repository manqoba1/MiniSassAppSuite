...
public class StaffAdapter extends ArrayAdapter<TeamMemberDTO> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        sb.append("monitor_images/company").append(SharedUtil.getTeamMember(ctx).getTeamMemberID());
        sb.append("/companyStaff/t").append(p.getTeamMemberID()).append(".jpg");
