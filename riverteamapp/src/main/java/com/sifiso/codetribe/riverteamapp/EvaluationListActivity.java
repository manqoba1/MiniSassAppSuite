...
import com.sifiso.codetribe.minisasslibrary.activities.*;
...
public class EvaluationListActivity extends ActionBarActivity implements CreateEvaluationListener {

    EvaluationListFragment evaluationListFragment;
    List<EvaluationSiteDTO> evaluationSiteList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        evaluationSiteList = (List<EvaluationSiteDTO>) getIntent().getSerializableExtra("evaluationSite");
    ...
    public void onRefreshMap(RiverDTO river, int result) {
        Intent intent = new Intent(EvaluationListActivity.this, com.sifiso.codetribe.minisasslibrary.activities.MapsActivity.class);
