...
public class Profile extends ActionBarActivity implements BusyListener, TeamMemberAddedListener, TeamListener {
    ...
    static String LOG = Profile.class.getSimpleName();
